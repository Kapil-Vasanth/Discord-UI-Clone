...
function Friend() {
    return (
        <div className="bg-[#2f3136] flex h-screen w-full text-slate-100 text-sm">
            <div className='bg-[#2f3136] p-2 min-w-[250px]' >
                <input type="text" className='bg-[#23272a] p-[6px] w-full' placeholder='Find or start a conversation' />
                <div className='py-2 flex flex-col space-y-2 text-sm'>
                  <NavLink to="/dashboard/friend/add-friend" className={({isActive}) => isActive ? "flex p-[6px] bg-[#36393f]" : 'flex p-[6px] opacity-70'}>
                    <span className='mr-3'>
                    <svg width="20" height="20">{friendsSvg}</svg>
                    </span>
                        Friends
                  </NavLink>
                  <NavLink to="/dashboard/friend/stage-discovery" className={({isActive}) => isActive ? "flex p-[6px] bg-[#36393f]" : 'flex p-[6px] opacity-70'}>
                    <span className='mr-3'>
                    <svg width="20" height="20">{stageDiscoverySvg}</svg>
                    </span>
                    Stage Discovery
                  </NavLink>
                  <NavLink to="/dashboard/friend/nitro" className={({isActive}) => isActive ? "flex p-[6px] bg-[#36393f]" : 'flex p-[6px] opacity-70'}>
                    <span className='mr-3'>
                        <svg width="20" height="20">{nitroSvg}</svg>
                    </span>
                      Nitro
                  </NavLink>
                </div>
                <div>    
                    <a href="" className="text-white flex justify-between mt-2">DIRECT MESSAGES<span>+</span></a> 
                </div>
            </div>
        </div>
      )
